...
public final class NNCalcController1 implements NNCalcController {
    ...
    public void processEnterEvent() {
        ...
        // top copies bottom and view is updated
        top.copyFrom(bottom);
        updateViewToMatchModel(this.model, this.view);
...
// Update View with changes
    ...
    public void processSubtractEvent() {
        ...
        // bottom subtracted from top then transferred to bottom
        top.subtract(bottom);
    ...
    public void processMultiplyEvent() {
        ...
        // top multiplied by bottom and tranferred to bottom
        top.multiply(bottom);
        bottom.transferFrom(top);
    ...
    public void processDivideEvent() {
        ...
        // top divided by bottom and remainder is stored
        NaturalNumber remainder = top.divide(bottom);

        // top transferred to bottom, then remainder transferred to top
        bottom.transferFrom(top);
    ...
    public void processPowerEvent() {
        ...
        // bottom is powered to top and converted to integer
    ...
    public void processRootEvent() {
        ...
        // bottom is rooted to the top's number
    ...
    public void processAddNewDigitEvent(int digit) {
        ...
        // Multiply the bottom by 10 and add the new digit
